...
export const LoginPage: React.FC<Props> = ({ onSignIn, onSignUp, onSignInWithGoogle, onSignInWithMagicLink, error, loading }) => {
    ...
    <div className="login-page">
      <div className="login-card">
        ...
        {magicLinkSent ? (
          ...
          <>
            <button type="button" className="google-btn" onClick={onSignInWithGoogle} disabled={loading}>
